...
addpath('C:\Program Files\MATLAB\R2014b\toolbox\matlab\iofun\');
addpath('C:\Program Files\MATLAB\R2014b\toolbox\matlab\iofun\private\');
...
if numHeaderRows
    ...
    Data = textscan(fileString,'%[^\n]',1,'HeaderLines',firstLineOffset,...
        'Delimiter',delim.requested,'EndOfLine','\n');
...
try
    if numDataCols
        ...
        Data = textscan(fileString,formatString,'Delimiter',delim.requested, ...
            ...
            'HeaderLines',numHeaderRows, 'CollectOutput', true,'EndOfLine','\n');
        if (numHeaderCols)
            numericData = Data{2};
        else
            numericData = Data{1};
...
if delim.printed == ' '
    ...
    cellOut = textscan(fileString,'%s','Delimiter',delim.requested,...
        'MultipleDelimsAsOne', 1, 'Whitespace','','EndOfLine','\n');
