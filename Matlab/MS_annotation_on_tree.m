function [full_MS_table, nodes_names, Unite_MS_Nodes] = MS_annotation_on_tree(tree, ms_mat,cell_names)
...
for i=1:length(nodes_names),
    ...
    tree_new_names(i) = regexprep(tree_new_names(i),'+','_plus');
    tree_new_names(i) = regexprep(tree_new_names(i),'-','_minus');
end
...
for i=1:length(cell_names),
    ...
    new_cell_names(i) = regexprep(new_cell_names(i),'+','_plus');
    new_cell_names(i) = regexprep(new_cell_names(i),'-','_minus');
