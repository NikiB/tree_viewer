function [  ] = generate_tree_legend_group_enrichment(Params,fig_name)
...
fprintf(fid,'The width of the colored branches represents the level of clustering significance (wider = lower P value)\n');
fclose all;
